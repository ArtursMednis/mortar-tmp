...
export class FireMission {
    ...
    // visas html failâ lietotâs funkcijas ievietot ðajâ klasç, kâ piekïuves punktâ
    // padomât par ðo: apakðçjâs klases par fireMission neko nezina, bet fireMission ir kâ observeris apakðçjâm klasçm un pats izdara kas vajadzîgs
    // iGeoLocationElement ðeit implementçt observable modeli
}
